        ...
        <div class="shopSearchHeader">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 乐淘 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜乐淘" class="searchTmall">
                </div>
    ...
    <div class="loginDiv">
        ...
        <div class="qrcodeLogin">
            ...
            <div class="qrcodeFooter">
                ...
                <p>打开 <a href="https://www.tmall.com/wow/portal/act/app-download">手机乐淘</a> | <a
...
<div class="context">
    ...
    <div class="context_info">
        ...
        <ul class="context_other_panel">
            ...
            <li class="tmall_points">送乐淘积分<span><fmt:formatNumber type="number"
