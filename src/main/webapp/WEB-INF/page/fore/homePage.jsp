...
<nav>
    ...
    <div class="header">
        <img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/01.png">
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 乐淘 商品/品牌/店铺"
                           maxlength="50">
    ...
    <div class="home_nav">
        ...
        <a href="http://vip.tmall.com/" target="_blank">乐淘会员</a>
